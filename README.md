## rosidl_runtime_py (jazzy) - 0.13.2-1

The packages in the `rosidl_runtime_py` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy rosidl_runtime_py` on `Tue, 02 Jun 2026 09:31:16 -0000`
...
## rosidl_runtime_py (rolling) - 0.16.0-1

The packages in the `rosidl_runtime_py` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling rosidl_runtime_py` on `Tue, 05 May 2026 17:30:52 -0000`
...
- upstream repository: https://github.com/ros2/rosidl_runtime_py.git
- release repository: https://github.com/ros2-gbp/rosidl_runtime_py-release.git
- rosdistro version: `0.15.2-2`
- old version: `0.15.2-2`
...
## rosidl_runtime_py (kilted) - 0.14.2-1

The packages in the `rosidl_runtime_py` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted rosidl_runtime_py` on `Thu, 09 Apr 2026 13:38:07 -0000`
...
## rosidl_runtime_py (rolling) - 0.15.2-1

The packages in the `rosidl_runtime_py` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl_runtime_py` on `Thu, 09 Apr 2026 13:31:16 -0000`
...
## rosidl_runtime_py (rolling) - 0.15.1-1

The packages in the `rosidl_runtime_py` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling rosidl_runtime_py` on `Tue, 29 Jul 2025 20:33:37 -0000`
...
## rosidl_runtime_py (rolling) - 0.15.0-1

The packages in the `rosidl_runtime_py` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release rosidl_runtime_py -r rolling` on `Fri, 25 Apr 2025 20:59:34 -0000`
...
## rosidl_runtime_py (rolling) - 0.14.1-1

The packages in the `rosidl_runtime_py` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release rosidl_runtime_py -r rolling` on `Fri, 18 Apr 2025 21:34:30 -0000`
